...
public class HospitalUpskillApplication {
    ...
    CommandLineRunner commandLineRunner() {
        return args -> {
            ...
            Doctor doctor = new Doctor("3", "Thiago", "medico", "medico@medico.com", "123", "Sintra", "Lisboa", "914789651", new GregorianCalendar(1998, Calendar.JUNE, 10), "cedula", Especialidade.CARDIOLOGIA.name(), UserRole.MEDICO_RESPONSAVEL);
            ...
            applicationUserService.enableAndSave(new Doctor("10", "Peter Baker", "medico1", "medico1@medico.com", "123", "Guaquira", "Pueblo Nuevo", "914789651", new GregorianCalendar(1998, Calendar.MARCH, 10), "cedula", Especialidade.ONCOLOGIA.name(), UserRole.MEDICO));
            applicationUserService.enableAndSave(new Doctor("11", "Corgi Maguire", "medico2", "medico2@medico.com", "123", "Paraguana", "Falcon", "914789651", new GregorianCalendar(1998, Calendar.FEBRUARY, 10), "cedula", Especialidade.FISIOTERAPIA.name(), UserRole.MEDICO));
            applicationUserService.enableAndSave(new Doctor("12", "Jenipuur Lopez", "medico3", "medico3@medico.com", "123", "El Serro", "Santa Ana", "914789651", new GregorianCalendar(1998, Calendar.JULY, 10), "cedula", Especialidade.GINECOLOGIA.name(), UserRole.MEDICO));
            applicationUserService.enableAndSave(new Doctor("13", "David Meowie", "medico4", "medico4@medico.com", "123", "El Hato", "Pueblo Nuevo", "914789651", new GregorianCalendar(1998, Calendar.MARCH, 10), "cedula", Especialidade.RADIOLOGIA.name(), UserRole.MEDICO));
            applicationUserService.enableAndSave(new Doctor("14", "Mitch Connor", "medico5", "medico5@medico.com", "123", "Adicora", "Paraguana", "914789651", new GregorianCalendar(1998, Calendar.DECEMBER, 10), "cedula", Especialidade.GERAL.name(), UserRole.MEDICO));
            applicationUserService.enableAndSave(new Doctor("15", "Mark Buffalo", "medico6", "medico6@medico.com", "123", "Piedras Negras", "Falcon", "914789651", new GregorianCalendar(1998, Calendar.JULY, 10), "cedula", Especialidade.OSTEOPATIA.name(), UserRole.MEDICO));
