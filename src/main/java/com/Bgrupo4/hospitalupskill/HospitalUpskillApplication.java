...
public class HospitalUpskillApplication {
	...
	CommandLineRunner commandLineRunner() {
		return args -> {
			...
			applicationUserService.enableAndSave(new Employee("2", "Tiago", "colaborador", "colaborador@medico.com", "123", "Sintra", "Sintra", "9180432423", new GregorianCalendar(1998, Calendar.JUNE, 10)));

			//Appointments
			Vaga vaga = new Vaga(new GregorianCalendar(2021, Calendar.MARCH, 13), "14:30", Especialidade.CARDIOLOGIA.name(), doctor);
